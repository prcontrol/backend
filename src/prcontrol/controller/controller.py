...
from prcontrol.controller.power_box import PowerBox, PowerBoxBricklets
...
class Controller:
    ...
    def __init__(self) -> None:
        ...
        reactor_box_bricklets = ReactorBoxBricklets(self.ipcon)
        power_box_bricklets = PowerBoxBricklets(self.ipcon)
